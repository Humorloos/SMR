...
class SmrWorld(World):
    ...
    def add_xmind_node(self, node: Tag, node_content: dict, ontology_storid: int, sheet_id: str,
        ...
        self.graph.execute(
            "INSERT INTO main.xmind_nodes VALUES (?, ?, ?, ?, ?, ?, ?, ?)", (
                node['id'], sheet_id, node_content['content'], node_content['media']['image'],
                node_content['media']['media'], ontology_storid, node['timestamp'], order_number))
    ...
    def add_xmind_edge(self, edge: Tag, edge_content: dict, sheet_id: str, order_number: int,
        ...
        self.graph.execute("INSERT INTO main.xmind_edges VALUES (?, ?, ?, ?, ?, ?, ?, ?)", (
            edge['id'], sheet_id, edge_content['content'], edge_content['media']['image'],
            edge_content['media']['media'], ontology_storid, edge['timestamp'], order_number))
