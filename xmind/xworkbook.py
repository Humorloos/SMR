...
class WorkbookElement(WorkbookMixinElement):
    ...
    def __init__(self, node, ownerWorkbook):
        ...
        namespace = (xconst.NAMESPACE, xconst.XMAP)
        attrs = [xconst.NS_FO, xconst.NS_XHTML, xconst.NS_XLINK, xconst.NS_SVG]
    ...
    def getSheets(self):
        sheets = self.getChildNodesByTagName(xconst.TAG_SHEET)
    ...
    def getVersion(self):
        return self.getAttribution(xconst.ATTR_VERSION)
...
class WorkbookDocument(Document):
    ...
    def __init__(self, node=None, path=None):
        ...
        self.setVersion(xconst.VERSION)
