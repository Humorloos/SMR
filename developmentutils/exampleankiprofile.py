...
def main():
    ...
    for name in os.listdir(user_directory):
        ...
        if os.path.isfile(path):
            ...
            shutil.rmtree(path)
    generate_new_file(src=cts.DEFAULT_COLLECTION_WITH_EXAMPLE_MAP_PATH, dst=os.path.join(
        user_directory, 'collection.anki2'))
    generate_new_tree(src=cts.DEFAULT_COLLECTION_WITH_EXAMPLE_MAP_MEDIA, dst=os.path.join(
